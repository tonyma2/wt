...
pub enum Command {
    ...
    #[command(
        long_about = "Clean up merged, stale, and orphaned worktrees.\n\n\
            ...
            Use --stale to also remove worktrees whose branch was never pushed and whose \
            last commit is older than the given number of days.\n\n\
    ...
    Prune {
        ...
        #[arg(long)]
        gone: bool,
        /// Also remove worktrees whose branch has no upstream and is idle for DAYS
